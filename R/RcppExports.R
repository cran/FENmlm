...
RcppPartialDerivative_new <- function(iterMax, Q, N, K, epsDeriv, ll_d2, F, init, dumMat, nbCluster) {
    .Call(`_FENmlm_RcppPartialDerivative_new`, iterMax, Q, N, K, epsDeriv, ll_d2, F, init, dumMat, nbCluster)
}

RcppPartialDerivative_gaussian_new <- function(iterMax, Q, N, K, epsDeriv, F, init, dumMat, nbCluster) {
    .Call(`_FENmlm_RcppPartialDerivative_gaussian_new`, iterMax, Q, N, K, epsDeriv, F, init, dumMat, nbCluster)
}
